...
Usage: ${1##*/} [-?vV] [-m message]
  ...
  Where:
    - m message = This is my advanced shell script.

    -v = Verbose mode - displays displaymsg function info
    -V = Very Verbose Mode - debug output displayed
    -? = Help - display this message

Author: Jeffery Asamani (jefferyasamani7@gmail.com)
...
#### Description:
#### 
####This function displays the default phrase \"Hello World\" or it displays a message provided by the user on the command line
#### 
#### Assumptions:
#### 
